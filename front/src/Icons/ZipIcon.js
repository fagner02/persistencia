  ...
  render() {
    return (
      <svg
        ...
        />
        <polygon xmlns="http://www.w3.org/2000/svg" points="14.582,27.766 18.356,27.766 14.31,36.317 14.31,38 20.6,38 20.6,36.164 16.571,36.164 20.6,27.613 20.6,25.964     14.582,25.964   "
        fill={this.state.color}
        />
        <rect xmlns="http://www.w3.org/2000/svg" x="22.436" y="25.964" width="2.04" height="12.036"
        fill={this.state.color}
        />
